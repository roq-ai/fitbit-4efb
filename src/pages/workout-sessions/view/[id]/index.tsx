...
import { getWorkoutSessionById } from 'apiSdk/workout-sessions';
...
function WorkoutSessionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Workout Session Detail View
          </Text>
          {hasAccess('workout_session', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/workout-sessions/edit/${data?.id}`} passHref legacyBehavior>
              <Button
